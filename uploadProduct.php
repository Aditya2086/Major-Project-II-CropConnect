...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title>Agri-Bizz : Upload product</title>
			...
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<form method="POST" action="uploadProduct.php" enctype="multipart/form-data">
						<h2 style="font-family: 'Balsamiq Sans', cursive;">Enter the Product Information here..!!</h2>
						<br>
				<center>
					<input type="file" name="productPic" style="color: black; font-family: 'Balsamiq Sans', cursive;" ></input>
					<br />
				</center>
				<div class="row">
					  <div class="col-sm-6">
						  <div class="select-wrapper" style="width: auto" >
							  <select name="type" id="type" required style="background-color:white;color: black;">
								  <option value="" style="color: black; font-family: 'Balsamiq Sans', cursive;">- Category -</option>
								  ...
								  <option value="Grains" style="color: black; font-family: 'Balsamiq Sans', cursive;">Grains</option>
				...
				<br>
				<div>
					<textarea  name="pinfo" id="pinfo" rows="3"></textarea>
				</div>
			<br>
			<div class="row">
				<div class="col-sm-6">
				...
				<div class="col-sm-6">
					<button class="button fit" style="width:auto; background:#143601; color:black; font-family: 'Balsamiq Sans', cursive;">Submit</button>
				</div>
			</div>
			</form>
		</div>
