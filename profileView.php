    ...
    <body>
        ...
        <section id="one" class="wrapper style1 align">
            <div class="inner">
                ...
                <header>
                    <center>
                    <span><img src="<?php echo 'images/profileImages/'.$_SESSION['picName'].'?'.mt_rand(); ?>" class="image-circle" class="img-responsive" height="100%"></span>
                    <br>
                    ...
                    <div class="row" id="row-profile">
                        ...
                        <div class="12u$"id="rows">
                            <center>
                                <div class="row uniform" id="row-uniform">
									<div class="3u 12u$(xsmall)"></div>
                                    <div class="3u 12u$(xsmall)"></div>
                                    <div class="3u 12u$(xsmall)">
            							<a href="uploadProduct.php" class="btn btn-danger" style="text-decoration: none; background:#143601"><span class="glyphicon glyphicon-upload" style="padding:7px"></span>Upload Product</a>
            						</div>
