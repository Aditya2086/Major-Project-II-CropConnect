	...
	?>
		...
		<!-- One -->
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<header>
						<h2 style="font-family: 'Balsamiq Sans', cursive;">CROPCONNECT</h2>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">CROPCONNECT &copy; </h3>
			<br />
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Patan Bypass Road, Raigwan<span>Jabalpur</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">+919977674606, +917389395922</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:cropinfo@gmail.com" style="color:white">cropinfo@gmail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About CropConnect</b></span>
				CropConnect is e-commerce trading platform for grains & groceries...
			</p>
			<div class="footer-icons">
				<a href="https://www.instagram.com/agro.connect2024/"><i style="margin-left: 0;margin-top:5px" class="fa fa-instagram"></i></a>
			</div>
		</div>
